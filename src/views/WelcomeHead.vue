<template>
  ...
  <el-menu
    ...
    >
      ...
      <div class="flex-grow" />
      <router-link to="/map"><el-menu-item index="1" class="front-color">查看地图</el-menu-item></router-link>
      
      <router-link to="/register/choose"><el-menu-item index="2" class="front-color">注册</el-menu-item></router-link>
      <router-link to="/Log/Choose"><el-menu-item index="3" class="front-color">登录</el-menu-item></router-link>
