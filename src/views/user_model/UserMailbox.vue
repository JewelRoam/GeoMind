  ...
  <div>
    ...
    <div class="container">
      <div class="box">
        <!-- <div class="sidebar">
          <ul>
            <li id="my-info"  ><RouterLink to="/user/info">我的信息</RouterLink></li>
            <li id="my-org" ><RouterLink to="/user/organization">我的组织</RouterLink></li>
            <li id="my-tasks" ><RouterLink to="/user/task/list">我的任务</RouterLink></li>
            <li id="my-mailbox" style="background-color: #4C4444;"><RouterLink to="/user/mailbox">我的信箱</RouterLink></li>
...
export default {
  ...
  data() {
    return {
      currentRoute: '/user/mailbox', // Initialize currentRoute as needed
  ...
  mounted() {
    ...
    this.user_info.id = sessionStorage.getItem('user_info.id');
  },
};
</script>
