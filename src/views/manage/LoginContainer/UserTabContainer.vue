<template>
      ...
      <div class="tab-container">
        <button @click="switchToUserType('标注员/审核员')" class="tab tab--1 user-type-button user-button">标注员/审核员</button>
        <button @click="switchToUserType('管理员')" class="tab tab--2 user-type-button">管理员</button>
